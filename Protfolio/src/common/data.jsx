...
export const projects = [
  {
    ...
    description:
      "Built a secure and responsive full-stack Expense Tracker using MERN stack with global state managed via Redux Toolkit. Implemented JWT-based authentication and developed an intuitive dashboard with categorized summaries, enabling users to securely view, filter, and analyze income and expenses through interactive charts.",
    technologies: [
      "Node.js",
      "React.js",
      "MongoDB",
    ...
    githubUrl: "https://github.com/Namra0904/My-Tracker",
  },
  {
    id: "chat-pulse",
    title: "Chat Pulse",
