    ...
    () => [
      {
        ...
        responsibilities: [
          "Leading the development of scalable backend services using Node.js, Express.js, and MongoDB for high-traffic production systems.",
          "Spearheaded Stripe Payment Gateway integration including automated payout systems for financial transactions.",
          "Built advanced timezone-aware booking logic for global availability calculations.",
          "Managed deployments, handled live debugging, and enhanced API performance for production-critical applications.",
        ],
      ...
      },
      {
        ...
        logo: "https://res.cloudinary.com/dffsbxpp4/image/upload/v1736673504/orkefyfw4fncuutkxxuz.png",
        responsibilities: [
          "Assisted in developing and maintaining backend services using Node.js, Express.js, and MongoDB, contributing to live production projects.",
          "Designed and implemented secure RESTful APIs for core functionalities including data transactions and business workflows.",
          "Enhanced security with JWT authentication, role-based access control (RBAC), and rate limiting.",
          "Contributed to Stripe integration for payment processing.",
          "Researched and implemented Google Wallet Pass and Apple Wallet Pass integration for digital pass distribution.",
          "Optimized MongoDB aggregations, indexing, and query performance for large-scale data handling.",
          "Architected modular backend systems with middleware layers and robust error handling.",
